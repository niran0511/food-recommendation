    ...
    <div className="container mx-auto px-4 md:px-6 py-8 max-w-7xl space-y-8 print:p-0">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 print:hidden">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-455 text-sm mt-1">
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-white/5 rounded-3xl p-6 shadow-xl space-y-4 print:hidden">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
              ...
              <div className="relative w-full sm:w-60">
                ...
                <input 
                  ...
                  className="w-full pl-9 pr-4 py-2 bg-slate-55/40 dark:bg-slate-950 border border-slate-200 dark:border-slate-850 rounded-xl text-xs text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-amber-500"
                />
              </div>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse text-xs">
                <thead>
                  <tr className="border-b border-slate-100 dark:border-white/5 text-slate-450 dark:text-slate-500 font-bold uppercase tracking-wider text-[10px]">
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-white/5 font-semibold text-slate-700 dark:text-slate-355">
                  {filteredRecords.length === 0 ? (
                    ...
                    filteredRecords.map(r => (
                      <tr 
                        ...
                        className={`hover:bg-slate-50 dark:hover:bg-white/5 transition-colors cursor-pointer ${selectedRecord?._id === r._id ? 'bg-amber-50/25 dark:bg-amber-955/10' : ''}`}
                      >
                        ...
                        <td className="p-3 text-right space-x-2.5 print:hidden" onClick={(e) => e.stopPropagation()}>
                          <button 
                            onClick={() => setSelectedRecord(r)}
                            className="p-1.5 bg-slate-100 dark:bg-white/5 rounded-lg text-slate-550 dark:text-slate-400 hover:bg-amber-500 hover:text-white dark:hover:bg-amber-500 dark:hover:text-slate-950 transition-all cursor-pointer"
                            title="View Report"
                          >
                            <Eye size={13} />
                          </button>
                          <button 
                            ...
                            className="p-1.5 bg-slate-100 dark:bg-white/5 rounded-lg text-slate-550 dark:text-slate-400 hover:bg-emerald-500 hover:text-white dark:hover:bg-emerald-500 dark:hover:text-white transition-all cursor-pointer"
                          ...
                          <button 
                            ...
                            className="p-1.5 bg-slate-100 dark:bg-white/5 rounded-lg text-slate-550 dark:text-slate-400 hover:bg-rose-500 hover:text-white dark:hover:bg-rose-500 dark:hover:text-white transition-all cursor-pointer"
                            title="Print Report"
                          >
                            <Printer size={13} />
                          </button>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-950/40 border border-slate-200/50 dark:border-slate-850 space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-xs font-black uppercase text-slate-450 dark:text-slate-500 tracking-wider">Obesity Index</span>
                ...
                <div className="space-y-2">
                  ...
                  <div className="w-full h-2 rounded-full bg-slate-250 dark:bg-white/5 overflow-hidden">
                    <div 
              ...
              <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-955/40 border border-slate-200/50 dark:border-slate-850 space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-xs font-black uppercase text-slate-450 dark:text-slate-500 tracking-wider">Diabetes (Type 2)</span>
              ...
              <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-955/40 border border-slate-200/50 dark:border-slate-850 space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-xs font-black uppercase text-slate-450 dark:text-slate-500 tracking-wider">Hypertension</span>
              ...
              <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-955/40 border border-slate-200/50 dark:border-slate-850 space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-xs font-black uppercase text-slate-450 dark:text-slate-500 tracking-wider">Heart Disease</span>
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-white/5 rounded-3xl p-6 shadow-xl space-y-5 text-slate-700 dark:text-slate-350 transition-colors duration-500">
              <div className="flex flex-col gap-1.5 border-b border-slate-100 dark:border-white/5 pb-3">
                ...
                <div className="mt-2 flex justify-between items-center bg-slate-50 dark:bg-slate-950 p-2.5 rounded-xl border border-slate-200/30 dark:border-white/5">
                  <span className="text-[9px] font-bold uppercase text-slate-450">Health Index Score</span>
                  <span className="text-xs font-black text-emerald-500">{selectedRecord.healthScore}/100</span>
                </div>
              </div>

              <div className="space-y-4 text-xs font-semibold">
                <div className="space-y-2 bg-slate-55/60 dark:bg-slate-950/40 p-3 rounded-2xl border border-slate-200/40 dark:border-slate-850">
                  <span className="text-slate-450 uppercase text-[9px] font-bold block">Clinical Vitals</span>
                ...
                <div className="space-y-2 bg-slate-55/60 dark:bg-slate-955/40 p-3 rounded-2xl border border-slate-200/40 dark:border-slate-850">
                  <span className="text-slate-455 uppercase text-[9px] font-bold block">Lifestyle Habits</span>
                  <div className="space-y-1.5">
                    ...
                    <p className="flex justify-between"><span>Mood State:</span> <strong className="text-slate-850 dark:text-slate-100">{selectedRecord.mood || 'N/A'}</strong></p>
                    <p className="flex justify-between"><span>Diet Adherence:</span> <strong className="text-slate-850 dark:text-slate-100">{selectedRecord.dietaryCompliance || 'N/A'}</strong></p>
                  </div>
                </div>

                <div className="space-y-2 bg-slate-55/60 dark:bg-slate-955/40 p-3 rounded-2xl border border-slate-200/40 dark:border-slate-850">
                  <span className="text-slate-455 uppercase text-[9px] font-bold block">Overrides & Meds</span>
                  <div className="space-y-1.5">
                ...
                <div className="space-y-2 bg-slate-55/60 dark:bg-slate-955/40 p-3 rounded-2xl border border-slate-200/40 dark:border-slate-850">
                  <span className="text-slate-455 uppercase text-[9px] font-bold block">Clinician Diagnostics Notes</span>
      ...
      {selectedRecord && (
        <div className="print-report-layout hidden print:block bg-white text-slate-900 p-8 space-y-6 text-xs border border-slate-200 rounded-lg max-w-[21cm] min-h-[29.7cm] mx-auto font-sans leading-relaxed">
          <div className="flex justify-between items-center border-b-2 border-slate-900 pb-4">
            <div>
              <h1 className="text-xl font-extrabold tracking-tight text-slate-955 uppercase">NutriAI Medical Center</h1>
              <p className="text-[10px] text-slate-550 font-bold uppercase tracking-wider">Clinical Nutrition & Diagnostics Division</p>
          ...
          <div className="grid grid-cols-2 gap-4 bg-slate-50 p-4 border border-slate-200 rounded-xl">
            <div className="space-y-1">
              ...
              <p className="text-sm font-black text-slate-955">Name: Niranjan S</p>
          ...
          <div className="space-y-2 pt-2">
            ...
            <div className="grid grid-cols-4 gap-4 text-center">
              <div className="p-3.5 border border-slate-200 rounded-xl bg-slate-50/20">
                ...
                <span className="text-sm font-black text-slate-900">{riskData && Math.round(riskData.obesity_risk * 100)}%</span>
              </div>
              <div className="p-3.5 border border-slate-200 rounded-xl bg-slate-50/20">
                <span className="text-[9px] text-slate-450 font-bold uppercase block">Diabetes Index</span>
                <span className="text-sm font-black text-slate-900">{riskData && Math.round(riskData.diabetes_risk * 100)}%</span>
              </div>
              <div className="p-3.5 border border-slate-200 rounded-xl bg-slate-50/20">
                <span className="text-[9px] text-slate-450 font-bold uppercase block">Hypertension Index</span>
                <span className="text-sm font-black text-slate-900">{riskData && Math.round(riskData.hypertension_risk * 100)}%</span>
              </div>
              <div className="p-3.5 border border-slate-200 rounded-xl bg-slate-50/20">
                <span className="text-[9px] text-slate-450 font-bold uppercase block">Heart Disease Index</span>
                <span className="text-sm font-black text-slate-900">{riskData && Math.round(riskData.heart_disease_risk * 100)}%</span>
              </div>
            </div>
            <p className="text-[10px] text-slate-550 text-center font-bold mt-2">Overall Patient Health Standing: {riskData && riskData.overall_health_score}% Optimal Condition</p>
          </div>
