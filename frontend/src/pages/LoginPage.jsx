...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Clear persistent tracker logs on login to start fresh
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative group">
                      ...
                      <input
                        ...
                        className="block w-full pl-11 pr-4 py-3 border border-slate-200 rounded-xl bg-white text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-400 transition-all font-medium text-sm"
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-3.5 px-4 rounded-xl text-sm font-bold text-slate-900 bg-gradient-to-r from-amber-300 to-amber-500 hover:from-amber-250 hover:to-amber-400 active:scale-[0.98] transition-all shadow-md shadow-amber-500/10 cursor-pointer"
                >
